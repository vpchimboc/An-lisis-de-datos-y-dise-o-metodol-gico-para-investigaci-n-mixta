"""
Script de Análisis de Clúster K-Means Simplificado (sin scikit-learn)
...
# ============================================================================
# FASE 4: MODELING (Modelado - K-Means Simplificado)
# ============================================================================
...
for k in K_range:
    labels, centroids, inertia = kmeans_simple(X_scaled, k)
    inertias.append(inertia)
    print(f"  K={k}: Inercia={inertia:.2f}")

# Aplicar K-Means con K=3 (óptimo según la literatura)
optimal_k = 3
labels, centroids, inertia = kmeans_simple(X_scaled, optimal_k)
df_quant['Cluster'] = labels
